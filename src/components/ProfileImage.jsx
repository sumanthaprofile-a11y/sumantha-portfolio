    ...
    return (
      ...
      >
        <div className="flex flex-col items-center gap-3 text-center px-6">
          <span className="grid h-16 w-16 place-items-center rounded-full border border-accent/25 bg-accent/10">
            <UserRound className="h-7 w-7 text-accent/70" strokeWidth={1.5} />
          </span>
